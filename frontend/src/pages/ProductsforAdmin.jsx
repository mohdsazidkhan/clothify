...
import { Box, Table, Thead, Tbody, Tr, Td, Th, TableContainer, Button, Image, useToast, useDisclosure } from '@chakra-ui/react';
          ...
          <Table variant='striped' >
            <Thead>
              <Tr>
                ...
                <Th>Price</Th>
                <Th>
                  <Button colorScheme='facebook' onClick={onClickAdd} >Add New</Button>
                </Th>
              </Tr>
            </Thead>
            <Tbody>
